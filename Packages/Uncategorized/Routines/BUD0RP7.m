...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD0RP7",ZTDTH="",ZTDESC="UDS 10 REPORT TABLE 7" D ^%ZTLOAD D EOJ Q
 Q
EOJ ;
 D EN^XBVK("BUD")
 Q
...
PROC ;EP - called from taskman
 ...
 .;I DUZ=5634 Q:'$D(^DIBT(4734,1,DFN))
 .;I DUZ=5634 Q:$$HRN^AUPNPAT(DFN,DUZ(2))'=845231
 .K ^TMP($J)
 .Q:'$D(^AUPNPAT(DFN,0))
 .Q:'$D(^DPT(DFN,0))
 ...
 .D PRGHLST^BUD0RP7A
 .D PRGRLST^BUD0RP7A
 .;I $G(BUDPRGEL) D PRGELST^BUD0RP7A
 .D HTN^BUD0RP7B
 .D DM^BUD0RP7C
 Q
 ;
...
GENI ;general introductions
 ...
 W !,"of care indicators during the time period January 1 - December 31, 2010."
