...
EN(DATA,FAKE) ;EP -- BQI GET COMM ALERTS SPLASH
 NEW UID,II,DATE,IEN,COMM,CMN,DCAT,DIAG,DXC,DXN,NUM,OCDT,TYP,TYPE,TEMP
...
SOR ; Sort out the alerts
 ...
 .... S II=II+1,@DATA@(II)=COMM_U_TYPE_U_LINK_U_DCAT_U_NUM_U_TWEN_U_$$FMTE^BQIUL1(OCDT)_U_CMN_$C(30)
 ;
 Q
 ;
ERR ;
...
FND ;EP - Find the alerts for a date and a community
 NEW COMM,TYP,TYPE,DXC,DCAT,DCN,LOOK,ADATE,DXN,QFL,TWDT
