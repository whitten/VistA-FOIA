VENPCCQB ; IHS/OIT/GIS - PRE INSTALL ; DATA ENTRY MNEMONIC
 ;;2.6;PCC+;**1,2,3**;MAR 23, 2011
APCDTWC ; GENERATED FROM 'APCD WCE (ADD)' INPUT TEMPLATE(#XXX), FILE 9000010
 ; EP - WELL CHILD EXAM INPUT TEMPLATE FOR PCC AND PCC+
 ; 
 ;
...
POVX W !,"Unable to automatically add WELL CHILD EXAM as a POV!!!"
 Q
 ; 
DEV ; EP - ENTER DEVELOPMENT ASSESSMENT
...
NUTFILE ; MAKE ENTRIES IN V WC AND V PATIENT ED
 ...
 D LOU^VENPCCQC(TITLE,.LOU,.TIME,.FTIME) ; GET LEVEL OF UNDERSTANDING AND NUT ED TIME ; PATCHED BY GIS/OIT 1/17/2011
 D NVWCFILE^VENPCCQC(LOU,TIME) ; FILE RESULTS IN V WELL CHILD ; REQUIRES THE SELECTION ARRAY ; PATCHED BY GIS/OIT 1/17/2011
 D VPEFILE^VENPCCQC(LOU,FTIME,GRP) ; FILE RESULTS IN V PATIENT ED ; REQUIRES THE SELECTION ARRAY ; PATCHED BY GIS/OIT 1/17/2011
NUTX K ARR ; CLEANUP ARRAY
 Q
 ; 
PTED ; EP - ENTER PATIENT EDUCATION TOPICS
...
PEFILE ; AT THIS POINT WE HAVE THE FINAL SELECTION ARRAY AND ARE READY TO MAKE ENTRIES IN V WELL CHILD AND V PATIENT ED
 S (LOU,TIME,FTIME)="",GRP="I"
 D LOU^VENPCCQC(TITLE,.LOU,.TIME,.FTIME,.EDU) ; GET LEVEL OF UNDERSTANDING AND PT ED TIME ; PATCHED BY GIS/OIT 1/17/2011
 D PEWCFILE^VENPCCQC(LOU,TIME,EDU) ; FILE RESULTS IN V WELL CHILD ; REQUIRES THE SELECTION ARRAY ; PATCHED BY GIS/OIT 1/17/2011
 D VPEFILE^VENPCCQC(LOU,FTIME,GRP) ; FILE RESULTS IN V PATIENT ED ; REQUIRES THE SELECTION ARRAY ; PATCHED BY GIS/OIT 1/17/2011
 K ARR ; CLEANUP ARRAY
 Q
 ; 
