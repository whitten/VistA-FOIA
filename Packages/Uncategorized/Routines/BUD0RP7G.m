BUD0RP7G ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7F
 ...
 D LINE^BUD0RP7F
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7F
 W ?69,"|",!
...
DMRACE2 ;EP - second page of sections a,b
 D HEADER^BUD0RPTP Q:BUDQUIT  D T7H1^BUD0RP7F
 W ?29,"|",?41,"NON-HISPANIC/LATINO",?59,"|",!
 ...
 D LINE^BUD0RP7F
 I $Y>(IOSL-16) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H1^BUD0RP7F
 W ?69,"|",!
 ...
 W ?5,"with diabetes",?29,"|",$$C($P($G(BUDSECTC(9)),U,13)),?39,"|",$$C($P($G(BUDSECTC(9)),U,14)),?49,"|",$$C($P($G(BUDSECTC(9)),U,15)),?59,"|",$$C($P($G(BUDSECTC(9)),U,16)),?69,"|",! ;$$C($P($G(BUDSECTC(9)),U,9)),?79,"|",!
 D LINE1^BUD0RP7F
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H1^BUD0RP7F
 ...
 W ?5,"7% >= HBA1c <= 9%",?29,"|",$$C($P($G(BUDSECTC(12)),U,13)),?39,"|",$$C($P($G(BUDSECTC(12)),U,14)),?49,"|",$$C($P($G(BUDSECTC(12)),U,15)),?59,"|",$$C($P($G(BUDSECTC(12)),U,16)),?69,"|",! ;$$C($P($G(BUDSECTC(12)),U,9)),?79,"|",!
 D LINE1^BUD0RP7F
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H1^BUD0RP7F
