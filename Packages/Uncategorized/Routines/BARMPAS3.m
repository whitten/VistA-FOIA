...
HDR ; EP
 ; Write Billing Office Address
 I '$D(^XTMP("BARPAS"_BARRUNDT,"HDR")) D GETHDR   ; IHS/SD/PKD 1.8*20 4/5/11 Be sure Header is available
 ...
 ;
PG(L) ; EP
 ;start old code bar*1.*20  IHS/SD/PKD 1.8*20 Page Length correction
 ;I (IOSL-$Y)<L D
