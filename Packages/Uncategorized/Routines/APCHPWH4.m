APCHPWH4 ; IHS/CMI/LAB - PCC HEALTH SUMMARY - MAIN DRIVER PART 2 ;
 ;;2.0;IHS PCC SUITE;**4,6**;MAY 14, 2009;Build 11
 ;
 ;EO MEASURES IN PWH
EO ;EP - EO measures
 ...
 D S^APCHPWH1("5 quality measures.  This report card enables you to compare your")
 ...
 ;WEB SITE CHANGED PER CHRIS LAMER EMAIL
 ;go through each one
...
DGC ;EP - diabetes and glycemic control
 ...
 I APCHX="" D  K APCHX Q
 .D S^APCHPWH1("Your A1c was not checked in the past year.  You should have your A1c")
 .D S^APCHPWH1("checked at least twice a year.")
 .Q
 I $P(APCHX,U,2)="" D  Q
 .D S^APCHPWH1("Your A1c was checked on "_$P(APCHX,U)_" but there is no result on file.  You should ask")
 .D S^APCHPWH1("your provider about your A1c value.")
 D S^APCHPWH1("Your A1c value on "_$P(APCHX,U)_" was "_$P(APCHX,U,2)_".  The A1c goal")
 D S^APCHPWH1("for this report is less than 9%.  The IHS goal is less than 7%.")
 Q
...
DLDL ;EP - LDL
 ...
 I APCHX="" D  K APCHX Q
 .D S^APCHPWH1("Your LDL was not checked in the past year.  You should have your LDL")
 .D S^APCHPWH1("checked at least once a year.")
 .Q
 D S^APCHPWH1("Your LDL value on "_$$FMTE^XLFDT($P(APCHX,U))_" was "_$P(APCHX,U,2)_$S($P(APCHX,U,3)]"":" "_$P(APCHX,U,3),1:"")_".  The LDL goal")
 D S^APCHPWH1("for this report is less than 100 mg/dl.")
 Q
 ;
LDL(P,BDATE,EDATE,NORES) ;EP
 ...
 ;I %]"" S APCHC=APCHC+1,APCHT(9999999-$P(%,U,1),APCHC)="CPT: "_$P(%,U,2)
 ;S %=$$TRAN^APCH8DU(P,BDATE,EDATE,$O(^ATXAX("B","APCH LDL CPTS",0)),5)
 ;I %]"" S APCHC=APCHC+1,APCHT(9999999-$P(%,U,1),APCHC)="CPT: "_$P(%,U,2)
 ;I '$O(APCHT(0)) Q ""
 ;S %=$O(APCHT(0)) S C=$O(APCHT(%,0)) Q 1_"^"_(9999999-%)_"^"_APCHT(%,C)
 Q ""
 ;
LOINC(A,B) ;EP
 NEW %
...
DBP ;EP
 ...
 I APCHX="" D  K APCHX Q
 .D S^APCHPWH1("Your Blood Pressure was not checked in the past year.  You should have your")
 .D S^APCHPWH1("Blood Pressure checked at least three times a year.")
 .Q
 D S^APCHPWH1("Your Blood Pressure on "_$$FMTE^XLFDT($P(APCHX,U))_" was "_$P(APCHX,U,3)_".  The Blood Pressure")
 D S^APCHPWH1("goal for this report is less than or equal to 140/90 mmHg.  The IHS goal")
 D S^APCHPWH1("is less than 130/80 mmHg.")
 Q
 ;
FLU ;EP - FLU
 NEW APCHX
 ...
 I APCHX="" D  K APCHX Q
 .D S^APCHPWH1("You did not have a flu shot this year.  You should have a flu shot every")
 .D S^APCHPWH1("year.")
 .Q
 D S^APCHPWH1("You had your flu shot on "_$$FMTE^XLFDT($P(APCHX,U))_".  You should have a flu shot")
...
O2 ;EP - OXYGEN ASSESSMENT
 NEW APCHX,X,Y
 Q:$$AGE^AUPNPAT(APCHSDFN,DT)<18
 D S^APCHPWH1("Pneumonia-Oxygen Assessment",1)
...
OXSAT(V) ;was there ox sat at the visit
 ...
 I G Q $$FMTE^XLFDT(APCHD)_" NOT MET REFUSAL O2 SAT^2"
 ...
 .I G S APCHG=$$FMTE^XLFDT(APCHD)_" NOT MET REFUSAL LAB^2"
 I APCHG]"" Q APCHG
 S G=$$CPTREFT^APCHSMU(P,APCHD,APCHD,$O(^ATXAX("B","BGP CMS ABG CPTS",0)))
 I G Q $$FMTE^XLFDT(APCHD)_" NOT MET REFUSAL CPT^2"
