...
DMR3 ;EP
 ...
 W !,$$CTR($$LOC,80)
 W !,$$CTR("UDS 2008",80)
 W !!,"All Patients w/DM and A1c >9 by Race (Table 7)",!
 D GENI
 D PAUSE
...
DMR3L ;EP
 ...
 D DMR3H Q:BUDQUIT
 I '$D(^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3")) W !!,"No patients to report." Q
 D DMR3L1
 I $Y>(IOSL-3) D DMR3H G:BUDQUIT DMR3LX
 W !!,"TOTAL DM PATIENTS 18+ W/A1C >9% BY RACE: ",BUDTOT,!
DMR3LX ;
 Q
DMR3L1 ;
 I $Y>(IOSL-7) D DMR3H Q:BUDQUIT
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DMR3L2
 Q
DMR3L2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D DMR3H Q:BUDQUIT  W !,BUDRACE,!
 ...
 ...S BUDALL=^XTMP("BUD8RP7",BUDJ,BUDH,"DMR3",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
 ...
 I $Y>(IOSL-4) D DMR3H Q:BUDQUIT  W !,BUDRACE,!
