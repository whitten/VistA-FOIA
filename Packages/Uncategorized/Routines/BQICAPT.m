BQICAPT ;VNGT/HS/ALA-Community Alerts Patients ; 16 Oct 2008  11:49 AM
...
EN(DATA,PARMS) ; EP - BQI GET COMM ALERTS PATIENTS
 ...
 NEW PAT,QFL,RECORD,TEMP,VAL,VALUE,NAFLG,NAME,PDATA,DXCAT,PATNAM,NVAL
...
FND(CIEN,TYP) ;EP
 ...
 .. I (OCDT\1)'>ADATE Q
 .. S PAT=$P(^BQI(90507.6,CIEN,1,TYP,1,DXC,1,DXN,0),U,4),RECORD=$P(^(0),U,3),FILE=$P(^(0),U,5)
 .. S PATNAM=$P($G(^DPT(PAT,0)),U,1) S:PATNAM="" PATNAM="~"
 .. S @TEMP@(PATNAM,PAT,COMM,TYPE,DCAT,OCDT)=RECORD_U_FILE
 Q
 ;
SOR ; Sort out the alerts
 NEW COMM,TYPE,LINK,DCAT,NUM,OCDT,PATNAM
 S PATNAM=""
 ...
 ...... D STAND(PAT)
 ...... S HDR=$P(HEADR,"^",1,9)_"^T00045ALERT_TYPE^T00045DX_CAT^D00015VISITDATE^I00010VISIT_IEN^I00010DFN"_$C(30)
 ...... S II=II+1,@DATA@(II)=$P(VALUE,"^",1,9)_U_TYPE_U_DCAT_U_$$FMTE^BQIUL1(OCDT)_U_$S(FILE=9000010:RECORD,1:"")_U_PAT_$C(30)
 ;
DONE ;
 I $G(HDR)="" S HDR="T00030PN^T00030HRN^T00001SX^T00010AGE^D00030DOB^T00035DPCP^T00030COM^T00120DCAT^T00045ALERT_TYPE^T00045DX_CAT^D00015VISITDATE^I00010VISIT_IEN^I00010DFN"_$C(30)
 S @DATA@(0)=HDR
