...
PL(DFN) ; Loop through and retrieve Planned Events
 ...
 ;
 ;Planned Header
 S @DATA@(II)="I00010HIDE_CMET_IEN^I00010HIDE_VISIT_IEN^T00040CATEGORY^T00060PLANNED_EVENT^D00015PLANNED_EVNT_DATE^I00010HIDE_PREVIOUS_EVENT"_$C(30)
 ;
...
PREC(QIEN,RESULT) ; EP - Get a planned event record
 NEW TDATA,PROC,PROCNM,CAT,VISIT,PTNAME,DUE,PRV
 ...
 S PRV=$P(TDATA,U,11)
 ;
 S RESULT=QIEN_U_VISIT_U_CAT_U_PROCNM_U_DUE_U_PRV
 ;
 Q
 ;
