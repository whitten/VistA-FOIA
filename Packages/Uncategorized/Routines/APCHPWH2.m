...
ACTLEVEL ;EP - calld from pwh
 ...
 .D S^APCHPWH1("activity level to 300 minutes each week (60 minutes/day) helps you get")
 .D S^APCHPWH1("even more health benefits.")
 I APCHX="SOME ACTIVITY" D  Q
 .D S^APCHPWH1("Increasing your physical activity to 150 minutes each week (30 minutes/day)")
 .D S^APCHPWH1("helps you gain even more health benefits. Now you are on the way to losing")
 .D S^APCHPWH1("weight and better health.")
...
HTWTBMI ;EP - ht/wt/bmi component
 Q:$$AGE^AUPNPAT(APCHSDFN,DT)<19  ;no one under 19
 ...
 .D S^APCHPWH1("You should have your weight rechecked at your next visit.")
 .;BMI
 ...
 .D S^APCHPWH1("Your last weight was "_APCHWTLB_" pounds on "_$$FMTE^XLFDT($P(APCHWT,U,1))_".")
 .D S^APCHPWH1("No recent height on file.  You should have your height rechecked at ") D S^APCHPWH1("your next visit.")
 I APCHWTNG,'APCHHTNG D
 .D S^APCHPWH1("You are "_APCHFEET_" feet and "_APCHINCH_" inches tall.")
 .D S^APCHPWH1("No recent weight on file.  You should have your weight rechecked at ") D S^APCHPWH1("your next visit.")
 I APCHHTNG,APCHWTNG D
 .D S^APCHPWH1("No recent weight on file.  You should have your weight rechecked at ") D S^APCHPWH1("your next visit.")
 .D S^APCHPWH1("No recent height on file.  You should have your height rechecked at ") D S^APCHPWH1("your next visit.")
 Q
...
LASTVPP(P,BDATE,EDATE) ;
 ...
 ..Q:'$$ICD^ATXCHK(E,$O(^ATXAX("B","BGP GPRA PREGNANCY DIAGNOSES",0)),9)
 ..S G=1
 .Q
 Q G
 ;
BP ;EP - BP component
 ...
 D S^APCHPWH1(" ")
 ;S APCHBP=$$LASTITEM^APCLAPIU(APCHSDFN,"BP","MEASUREMENT",,,"A")
 ...
 ..D S^APCHPWH1("Your blood pressure goal should be less than 140/90.")
 ...
 ;I APCHDM D
 ;.D S^APCHPWH1("Since you have diabetes, knowing your blood pressure helps you see how well")
 ;.D S^APCHPWH1("your treatment is working.")
 I APCHDT>79!(APCHST>129) D  Q
 .D S^APCHPWH1("Your blood pressure goal should be less than 130/80.")
 .D S^APCHPWH1("Your blood pressure was too high.  Eating healthy foods, cutting back on")
 .D S^APCHPWH1("salt, and more physical activity can help lower blood pressure.  If you")
 .D S^APCHPWH1("take medicine to lower your blood pressure, be sure to take it everyday.")
 D S^APCHPWH1("Your blood pressure is good!  It is very important to have your blood")
 D S^APCHPWH1("pressure checked often.")
...
DMDX(P) ;EP
 ...
 I 'T Q ""
 S (X,Y,I)=0 F  S X=$O(^AUPNPROB("AC",P,X)) Q:X'=+X!(I)  I $D(^AUPNPROB(X,0)),$P(^AUPNPROB(X,0),U,12)="A" S Y=$P(^AUPNPROB(X,0),U) I $$ICD^ATXCHK(Y,T,9) S I=1
 I I Q 1
