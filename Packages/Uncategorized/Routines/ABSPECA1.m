...
ASCII(CLAIMIEN) ;EP - from ABSPOSQH from ABSPOSQG from ABSPOSQ2
 ...
 I 'IEN(9002313.92) D  G QERR ; insurer must have an e-format
 ...
 . S REVERSAL=1
 . S IEN(9002313.92)=$P(^ABSPF(9002313.92,IEN(9002313.92),"REVERSAL"),U)
 . I 'IEN(9002313.92) D  G QERR ; format must point to a reversal format
 . . S UERETVAL=$$IMPOSS^ABSPOSUE("DB","T",CLAIMIEN,,4,$T(+0))
 E  S REVERSAL=0
 ;
 I '$D(^ABSPF(9002313.92,IEN(9002313.92),0)) D  G QERR
