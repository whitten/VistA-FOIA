BARMPAS ; IHS/SD/LSL - Patient Account Statement ;
 ...
 ;       Routine Created.  Thanks to California area and contract with
 ;       Paul Wesley for code.  CAO routine AZLKPS0.
 ;
 ...
 ; !!!***!!!***
 ; IHS/SD/PKD - 9/10/10 Use of ^XTMP instead of ^TMP($J is Valid SAC usage
 ;             Add VisitLocation & DateOfService to the Sort in ^XTMP
 ;
 ; ********************************************************************
 Q
TASK ; EP
