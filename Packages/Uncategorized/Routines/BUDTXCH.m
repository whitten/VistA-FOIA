BUDTXCH ; IHS/CMI/LAB - TAXONOMY CHECK FOR FY04 GPRA REPORT ;
 ;;5.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2011;Build 12
 ;
 ;
 D HOME^%ZIS
 W:$D(IOF) @IOF
 W !!,"Checking for Taxonomies to support the UDS Report. ",!,"Please enter the device for printing.",!
ZIS ;
 S XBRC="",XBRP="TAXCHK^BUDTXCH",XBNS="",XBRX="XIT^BUDTXCH"
 D ^XBDBQUE
 D XIT
 Q
TAXCHK ;EP
 D HOME^%ZIS
 K BUDQUIT
 W !,"Checking for Taxonomies to support the UDS Report...",!
 NEW A,BUDX,I,Y,Z,J
 K A
...
TAXS ;
 ...
 ;;BUD CPT PAP 03;;Pap CPTs Taxonomy
 ;;BGP PAP LOINC CODES
 ;;
LAB ;
 ;;BGP PAP SMEAR TAX
