...
EN(DATA,TYPE) ;EP -- BQI GET MEASURES LIST
 ...
 S @DATA@(II)=@DATA@(II)_"T00003EDIT^T00003BATCH^T00001DEFAULT_SORT"_$C(30)
 ;
 K BQISORT
...
RET ; Data retrieval
 ...
 NEW CAT,CLIN,RVIEW,MVIEW,PDIR,EXCEPT,SIZE
 S IEN=""
 ...
 .. I VER<8.0 D
 ... S PIND=$O(^BQI(90508,BQIH,20,BQIYR,20,"B",BQMEAS,"")) I PIND="" Q
