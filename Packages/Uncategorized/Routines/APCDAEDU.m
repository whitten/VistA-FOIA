...
P01 ;get .01 value by concatenating topic and dx
 NEW APCDY,APCDM
 S APCDY=$P($$ICDDX^ICDCODE($P(APCDT04,"`",2)),U,2)_"-"_$P(^APCDEDCV($P(APCDT12,"`",2),0),U),APCDM=$P(APCDY,"-")_"-"_$P(^APCDEDCV($P(APCDT12,"`",2),0),U,2)
...
ADDVPED ;add v patient education entry
 ...
 S DA=+Y,DIE="^AUPNVPED(",DR=".02////"_APCDPEDP_";.03////"_APCDPEDV_";.04///"_APCDT04_";.12///"_APCDT12_";1102;.06;.05;.08;.11;.13;.14;1101" D ^DIE
