BUD8RP6I ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
PRGAL ;EP
 ...
 D PRGAH Q:BUDQUIT
 I '$D(^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA")) W !!,"No patients to report." Q
...
PRGAL1 ;
 ...
 W !,BUDAB,!
 S BUDSTOT=0,BUDTOT=0
 S BUDA=0 F  S BUDA=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA",BUDAB,BUDA)) Q:BUDA'=+BUDA!(BUDQUIT)  D
 .S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA",BUDAB,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA",BUDAB,BUDA,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA",BUDAB,BUDA,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDALL=^XTMP("BUD8RP6B",BUDJ,BUDH,"PRGA",BUDAB,BUDA,BUDNAME,BUDCOM,DFN)
...
PRGAH1 ;
 ...
 W !?5,"VISIT DATE",?20,"DX OR SRV CD",?33,"SRV CAT",?41,"CLINIC",?60,"LOCATION"
 W !,$TR($J("",80)," ","-"),!
 S BUDP=1
 Q
 ;
...
IMM1L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D IMM1H Q:BUDQUIT
 I '$D(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM1")) W !!,"No patients to report." Q
 D IMM1L1
...
IMM1L1 ;
 ...
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM1",BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM1",BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM1",BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D IMM1H Q:BUDQUIT
 ...
 ...S BUDTOT=BUDTOT+1
 ...S BUDALL=$P(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM1",BUDNAME,BUDCOM,DFN),"|||",1)
 ...F BUDX=1:1 S BUDV=$P(BUDALL,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D IMM1H Q:BUDQUIT
 ....W ?4,BUDV,!
 Q
...
IMM2 ;EP
 ...
 W !!,"This report provides a list of two year old patients who had their first"
 W !,"visit prior to their 2nd birthday, had a medical visit during the report"
 W !,"period, and do not have all required childhood immunizations."
 W !
 Q
IMM2L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D IMM2H Q:BUDQUIT
 I '$D(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM2")) W !!,"No patients to report." Q
 D IMM2L1
...
IMM2L1 ;
 ...
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM2",BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM2",BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM2",BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D IMM2H Q:BUDQUIT
 ...W $E($P(^DPT(DFN,0),U,1),1,25),?29,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2)),?41,$E(BUDCOM,1,25),?70,$P(^DPT(DFN,0),U,2),?75,$$AGE^AUPNPAT(DFN,BUDED),!
 ...S BUDTOT=BUDTOT+1
 ...S BUDALL=^XTMP("BUD8RP6B",BUDJ,BUDH,"IMM2",BUDNAME,BUDCOM,DFN)
 ...F BUDX=1:1 S BUDV=$P(BUDALL,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D IMM2H Q:BUDQUIT
 ....W ?4,BUDV,!
 Q
...
IMM2H1 ;
 ...
 I BUDP=0 D
 .W !,"List of all 2-year old patients who had their first visit prior to their"
 .W !,"2nd birthday, had a medical visit during the report period, and do not have"
 .W !,"all required childhood immunizations."
 .W !,"Age is calculated as of December 31."
 W !!,"PATIENT NAME",?34,"HRN",?41,"COMMUNITY",?70,"SEX",?75,"AGE"
