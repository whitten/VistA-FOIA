ABSPOSCC ; IHS/FCS/DRS - Set up ABSP() ;      [ 05/09/2003  9:37 AM ]
 ;;1.0;PHARMACY POINT OF SALE;**1,4,6,9,11,15,16,17,19,20,21,29,37,40**;JUN 01, 2001
 ;---
...
GETINFO(DIALOUT,PATIEN,VSTIEN,PINS,INSIEN) ;EP
 ...
 S ABSP("Patient","Medicaid DOB")=$$CAIDDOB
 ;
 S ABSP("Patient","Medicare DOB")=""
 S:PINSTYPE="CARE" ABSP("Patient","Medicare DOB")=$$CAREDOB
 ;
 ...
 S ABSP("Insurer","Elig Dates")=$$CAIDELDT
