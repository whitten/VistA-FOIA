BUD0RPT1 ; IHS/CMI/LAB - UDS REPORT DRIVER 12 Dec 2010 8:11 AM ;
...
EN ;EP
EN1 ;
 I $G(BUDT6B) W !,"Table 6B:" D PRENATT^BUD0RP6B
 I $G(BUDT7) W !,"Table 7:" D PRENATT^BUD0RP7
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD0RPT1",ZTDTH="",ZTDESC="UDS 10 REPORT" D ^%ZTLOAD D EOJ Q
 Q
M ;EP - called from option
 ...
 W !?5,"7   Table 6B: Quality of Care Indicators"
 W !?5,"8   Table 7: Health Outcomes and Disparities"
 W !?5,"9   Multiple/ALL Tables Zip through 7"
 S DIR(0)="L^1:9",DIR("A")="Include which Tables",DIR("B")=1 KILL DA D ^DIR KILL DIR
 I $D(DIRUT) D EOJ Q
 I Y[9 S (BUDT3A,BUDT3B,BUDT4,BUDT5,BUDT6,BUDTZ,BUDT5L1,BUDT6B,BUDT7)=1
 I Y[2 S BUDT3A=1
 I Y[3 S BUDT3B=1
