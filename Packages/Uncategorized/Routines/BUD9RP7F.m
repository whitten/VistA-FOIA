BUD9RP7F ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 03 Dec 2009 6:10 AM 30 Dec 2009 8:12 PM ;
...
PRINT ;EP
 ...
 W ?29,"|",?41,"NON-HISPANIC/LATINO",?69,"|",!
 ...
 D LINE1
 D DMRACE1^BUD9RP7G  ;rest of page 1
NEXT ;second page of sections a,b
 D HEADER^BUD9RPTP Q:BUDQUIT  D T7H1
 W ?29,"|",?31,"NON-HISPANIC/LATINO IDENTITY",?59,"|",!
 ...
 W ?5,"patients",?29,"|",$$C($P($G(BUDSECTB(6)),U,13)),?39,"|",$$C($P($G(BUDSECTB(6)),U,14)),?49,"|",$$C($P($G(BUDSECTB(6)),U,15)),?59,"|",!  ;,?59,"|",$$C($P($G(BUDSECTB(6)),U,8)),?69,"|",$$C($P($G(BUDSECTB(6)),U,9)),?79,"|",!
 D LINE5
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T7H1
 W ?2,"7",?5,"Charts sampled or",?29,"|",?39,"|",?49,"|",?59,"|",!  ;,?59,"|",?69,"|",?79,"|",!
 W ?5,"EHR total",?29,"|",$$C($P($G(BUDSECTB(7)),U,13)),?39,"|",$$C($P($G(BUDSECTB(7)),U,14)),?49,"|",$$C($P($G(BUDSECTB(7)),U,15)),?59,"|",!  ;,?59,"|",$$C($P($G(BUDSECTB(7)),U,8)),?69,"|",$$C($P($G(BUDSECTB(7)),U,9)),?79,"|",!
 D LINE5
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T7H1
 W ?2,"8",?5,"Patients with ",?29,"|",?39,"|",?49,"|",?59,"|",!  ;,?59,"|",?69,"|",?79,"|",!
 ;W ?5,"controlled blood",?29,"|",?39,"|",?49,"|",!  ;,?59,"|",?69,"|",?79,"|",!
 W ?5,"HTN controlled",?29,"|",$$C($P($G(BUDSECTB(8)),U,13)),?39,"|",$$C($P($G(BUDSECTB(8)),U,14)),?49,"|",$$C($P($G(BUDSECTB(8)),U,15)),?59,"|",!  ;,?59,"|",$$C($P($G(BUDSECTB(8)),U,8)),?69,"|",$$C($P($G(BUDSECTB(8)),U,9)),?79,"|",!
 D LINE5
 D DMRACE2^BUD9RP7G
 Q
 ;
