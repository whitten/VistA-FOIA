BARRPSRA ; IHS/SD/LSL - New Period Summary Report ; 08/20/2008
...
DATA ; EP
 ...
 I ",3,4,13,14,15,16,19,20,"'[(","_BARTR("ADJ CAT")_",")&(",40,49,39,108,503,"'[(","_BARTR("T")_",")) Q
 S:(BARTR("T")=49!(BARTR("T")=503)) BAR(1)=BARTR("CR-DB")
 S:BARTR("T")=40 BAR(2)=BARTR("CR-DB")
 S:(",3,4,13,14,15,16,20,"[(","_BARTR("ADJ CAT")_",")) BAR(3)=BARTR("CR-DB")
 ...
 . ;I BARTR("ALL")="K" S BAR("SUB3")="CHIPS"  ;BAR*1.8*6 DD 4.1.1 IM21585
 . I BARTR("ALL")="K" S BAR("SUB3")="MEDICAID"  ;BAR*1.8*6 DD 4.1.1 IM21585
 . I BARTR("ALL")="P" S BAR("SUB3")="PRIVATE INSURANCE"
 I BARY("STCR")=6 D
 . ;I $L(BARTR("BI"))=1 S BAR("SUB3")=$P($T(@BARTR("BI")),";;",2)
 . I $L(BARTR("BI")) S BAR("SUB3")=$P($T(@BARTR("BI")),";;",2)  ;BAR*1.8*1 IM21585
 . E  S BAR("SUB3")=BARTR("BI")
 I BARY("STCR")=7 D
 . ;I $L(BARTR("BI"))=1 S BAR("SUB3")=$P($T(@BARTR("BI")),";;",3)
 . I $L(BARTR("BI")) S BAR("SUB3")=$P($T(@BARTR("BI")),";;",3)  ;BAR*1.8*1 IM21585
 . E  S BAR("SUB3")="No Insurer Type"
 S BAR("SUB4")=BARTR("I")
...
XIT ;
 ...
 ; *********************************************************************
 ;
 ;IM20678 BAR*1.8*1 ADDED LINE FOR THIRD PARTY LIABILITY,
 ;GUARANTOR AND MCR PART D
