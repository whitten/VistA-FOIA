BUD0RP7Q ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DMRACE1 ;EP - called from taskman
 ...
 ;S BUDQUIT=0
 D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7P
 ...
 D LINE^BUD0RP7P
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7P
 W ?69,"|",!
 ...
 W ?5,"with diabetes",?29,"|",$$C($P($G(BUDSECTC(9)),U,17)),?49,"|",$$C($P($G(BUDSECTC(9)),U,18)),?69,"|",!  ;,?79,"|",!
 D LINE1^BUD0RP7P
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7P
 ...
 W ?5,"7% >= HBA1c <= 9%",?29,"|",$$C($P($G(BUDSECTC(12)),U,17)),?49,"|",$$C($P($G(BUDSECTC(12)),U,18)),?69,"|",!  ;,?79,"|",!
 D LINE1^BUD0RP7P
 I $Y>(IOSL-3) D HEADER^BUD0RPTP Q:BUDQUIT  D T7H^BUD0RP7P
