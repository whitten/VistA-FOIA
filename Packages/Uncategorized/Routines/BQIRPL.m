BQIRPL ;PRXM/HC/DLS - Patient Problem List  ; 15 Jun 2008  8:09 PM
 ...
 Q
 ;
EN(DATA,DFN,DRANGE,BQPIEN) ; EP - BQI PATIENT PROBLEM LIST
 ;Description
 ...
 ;
 S BQPIEN=$G(BQPIEN,""),DFN=$G(DFN,""),DRANGE=$G(DRANGE,"")
 ;
 D HDR
 ;
...
GETDATA(BQPIEN) ;EP
 ...
 S @SDATA@(BQST,BQAPID,BQPIEN)=BQPRID_U_BQPRBDT_U_LOC_U_BQIUSUP_U_BQIUPDT_U_BQDX_U_BQCLS_U_$G(BQSTN)_$C(28)_BQST_U_BQONSET_U_HBQNARR_U_BQNARR_U_BQNOTE_U_BQICLAS_U_DFN
...
HDR ;
 ...
 S @DATA@(BQII)=@DATA@(BQII)_"T00080PRVNAR^T01024PBLNOTES^T00030APCDCLAS^I00010DFN"_$C(30)
...
UPD(DATA,DFN,TYPE,PBLIEN,PARMS) ;EP - BQI UPDATE PROBLEM LIST
 ...
 .. S RESULT=$$ADDPROB^APCDALV2("`"_APCDDX,APCDP,APCDDLM,APCDCLS,"`"_APCDN,APCDFAC,APCDDTE,APCDSTAT,APCDDOO,APCDCLAS,$G(APCDEBU))
