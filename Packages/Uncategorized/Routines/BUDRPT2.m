BUDRPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDUSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUDRPTP",XBRC="PROC^BUDRPTC",XBRX="EOJ^BUDRPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
 ;Q
ZIS ;call to XBDBQUE
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUDRPT2",ZTDTH="",ZTDESC="UDS 03 REPORT" D ^%ZTLOAD D EOJ Q
 Q
...
GENI ;general introductions
 ...
 W !,"List report."
 W !!,"Based on the UDS definition, visits must meet the following criteria:"
