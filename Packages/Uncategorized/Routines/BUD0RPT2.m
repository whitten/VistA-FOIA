BUD0RPT2 ; IHS/CMI/LAB - UDS REPORT DRIVER 02 Dec 2007 11:27 AM 12 Dec 2010 8:12 AM ;
...
EN1 ;
 S BUDSITE=""
 W ! S DIC="^BUDTSITE(",DIC(0)="AEMQ",DIC("A")="Enter your site: " D ^DIC
 I Y=-1 D EOJ Q
 S BUDSITE=+Y
 ...
 I $D(DIRUT) D EOJ Q
 I Y D EOJ Q
 ;S XBRP="PRINT^BUD0RPTP",XBRC="PROC^BUD0RPTC",XBRX="EOJ^BUD0RPT2",XBNS="BUD"
 ;D ^XBDBQUE
 ;D EOJ
ZIS ;call to XBDBQUE
 K IOP,%ZIS
...
TSKMN ;EP ENTRY POINT FROM TASKMAN
 ...
 S ZTCPU=$G(IOCPU),ZTRTN="DRIVER^BUD0RPT2",ZTDTH="",ZTDESC="UDS 10 REPORT" D ^%ZTLOAD D EOJ Q
 Q
