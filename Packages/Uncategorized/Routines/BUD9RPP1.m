BUD9RPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2007 6:26 AM 30 Dec 2009 10:42 AM ;
 ;;5.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2011;Build 12
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDFNP=1,BUDTYPE="D"
 D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 K BUDFNP
 W !,"SELECTED INFECTIOUS AND PARASITIC DISEASES"
 W !," 1.  Symptomatic HIV",?35,$$CTR("042,079.53",15),?56,$$C($P(BUDT6("V"),U,1)),?70,$$C($P(BUDT6("P"),U,1)),!,BUD80L
 ...
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 W !," 9.  Diabetes mellitus",?35,$$CTR("250.xx; 648.0x;",15),!?35,$$CTR("775.1x",15),?56,$$C($P(BUDT6("V"),U,9)),?70,$$C($P(BUDT6("P"),U,9)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 W !,?35,$$CTR("278.00-278.02,",15)
 W !?35,$$CTR("V85.xx excluding",15)
 W !,"14a. Overweight and obesity",?35,$$CTR("V85.0, V85.1,",14),?56,$$C($P(BUDT6("V"),U,60)),?70,$$C($P(BUDT6("P"),U,60))
 W !?35,$$CTR("V85.51, V85.52",15),!,BUD80L
 I $Y>(IOSL-6) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 W !,"22.  Mammogram",?33,"CPT-4: 77052, 77057",!,?33,"OR ICD-9: V76.11, V76.12"
 ...
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 W !,"23.  Pap Test",?33,"CPT-4: 88141-88155, 88164-88167",!?33,"88174-88175, OR"
 ;W !?33,"G0101, G0123, G0124, G0141, G0143,",!?33,"G0144, G0145, G0147, G0148, P3000",!?33,"P3001, Q0091"
 ...
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 W !,"24a. Seasonal Flu vaccine",?33,"CPT-4: 90655-90662",?56,$$C($P(BUDT6("V"),U,65)),?70,$$C($P(BUDT6("P"),U,65)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 W !,"26.  Health supervision of infant",?34,"Clinic code 24, 57;",!?6," or child (ages 0 - 11)",?34,"CPT-4: 99391-99393;",!?34,"99381-99383"
 ...
 I $Y>(IOSL-3) D HEADER^BUD9RPTP Q:BUDQUIT  D T6SH1
 W !,"26c. Smoke/Tobacco counseling",?35,"CPT-4: 99406 and 99407;"
 W !?6,"Smoking cessation treatment",?35,"S9075; Pat Ed: TO-*;",?56,$$C($P(BUDT6("V"),U,63)),?70,$$C($P(BUDT6("P"),U,63))
