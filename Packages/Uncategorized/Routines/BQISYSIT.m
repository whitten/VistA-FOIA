...
JOB(DATA,FAKE) ; EP - BQI GET SYSTEM JOB DATA
 ...
 I $O(^DIC(19.2,"B",OPTN,""))="" S BQSCHED="Not scheduled"
 S JOB="WEEKLY",FLDS="Diagnostic Tags;4.01;4.02;4.03^Natl Measures;4.04;4.05;4.06^Reminders;4.07;4.08;4.09^Best Practice Prompts;4.1;4.11;4.12^Care Mgmt Update;4.13;4.14;4.15" D RET
 ;
 S II=II+1,@DATA@(II)=$C(31)
 Q
 ;
