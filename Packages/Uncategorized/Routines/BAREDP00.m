BAREDP00 ; IHS/SD/LSL - AR ERA AUTO-POSTIEG ; 01/30/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**1,5,6,7,10,17,20**;OCT 26,2005
 ;;HEAT10729 pkd-3/31/10
 Q
...
INSTALL ;EP - Load New Import
 ...
 S ANS="Y"
 K FILE  ;bar*1.8*20
 ;I $D(^BAREDI("I",DUZ(2),"C",HSTFILE)) D  ;bar*1.8*20 REQ5
 ...
 .D ^DIR
 .;Q:$D(DIRUT)  ;bar*1.8*20 REQ5
 .I $D(DIRUT)!Y=0 S ANS="N" Q  ;bar*1.8*20 REQ5
 .;start new bar*1.8*20 REQ4
 .I BARFLG=1 D
 ..K DIR
 ..S DIR(0)="Y"
 ...
 .K DIR
 .S ANS=$S(+Y:"Y",1:"N")
 .Q:ANS'="Y"  ;MRS:BAR*1.8*6 DD 4.2.4
 .;S:'$$CKDATE^BARPST(HSTFILE,1,"SELECT ERA FILE") ANS="N" ;DISALLOW PRE-FY05;MRS:BAR*1.8*6 DD 4.2.4;MRS:BAR*1.8*7 IM30386 
 Q:ANS'="Y"
 K XBY,XBGUI
 ...
 .;W !,"did not load into RPMS successfully."
 .;BEGIN NEW BAR*1.8*1 TPF 1/25/06 IM19629
 ...
 .W !,"The file ",HSTFILE," in directory ",XBDIR
 .W !,"is not a HIPAA compliant 835 Remittance Advice.  It cannot be loaded."
 .D EOP^BARUTL(1)
 I TRNAME'["HIPAA",+BARHIPAA D  Q
 .W !,"The file ",HSTFILE," in directory ",XBDIR
 .W !,"is a HIPAA compliant 835 Remittance Advice."
 .W !,"Please use the HIPAA 835 v4010 Transport when loading this file."
 .D EOP^BARUTL(1)
 S X=$O(^TMP($J,"ERA",""),-1)
 W !,"LINE COUNT LOADED: ",X,!
 H 3
 I X'>0 G INSTALL
 ;Update global ^BAREDI("I" w/transport file
 ;Get IMPDA
 K DIC
 S DIC=$$DIC^XBDIQ1(90056.02)
 S DIC(0)="EL"
 S X=HSTFILE  ;bar*1.8*20 REQ4
...
VIEW ; EP
 ...
 .W !!,"Check your DUZ setup."
 .D EOP^BARUTL(1)
 N RPTLOOK S RPTLOOK=1  ;HEAT10729 BAR*1.8*17 PKD 3/31/10
 D SELFL
 I Y'>0 Q
