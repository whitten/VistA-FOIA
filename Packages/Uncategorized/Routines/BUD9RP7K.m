BUD9RP7K ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
HTEL ;EP
 ...
 D HTEH Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE")) W !!,"No patients to report." Q
 D HTEL1
...
HTEL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D HTEL2
 Q
HTEL2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,BUDA,?55,$P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),!
 ....S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ....S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"HTE",BUDRACE,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"#",1)
...
HTCEL ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D HTCEH Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE")) W !!,"No patients to report." Q
 D HTCEL1
...
HTCEL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D HTCEL2
 Q
HTCEL2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D HTCEH Q:BUDQUIT  W !,BUDRACE,!
 ...W !?2,$E($P(^DPT(DFN,0),U,1),1,20),?24,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2))
 ...W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,$$AGE^AUPNPAT(DFN,BUDED),?55,$P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),!
 ...S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ...S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"HTCE",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
 ...F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D HTCEH Q:BUDQUIT  W !,BUDRACE,!
...
HTUEL ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D HTUEH Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE")) W !!,"No patients to report." Q
 D HTUEL1
...
HTUEL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D HTUEL2
 Q
HTUEL2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D HTUEH Q:BUDQUIT  W !,BUDRACE,!
 ...W !?2,$E($P(^DPT(DFN,0),U,1),1,20),?24,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2))
 ...W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,$$AGE^AUPNPAT(DFN,BUDED),?55,$P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),!
 ...S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ...S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"HTUE",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
 ...F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D HTUEH Q:BUDQUIT  W !,BUDRACE,!
