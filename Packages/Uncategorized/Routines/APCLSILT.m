APCLSILT ;IHS/CMI/LAB - AGGREGATE ILI REPORT PRINT; 
...
ILISEX ;EP
 ...
 W "TABLE 3:  ILI / H1N1 Diagnoses by Sex"
 W !,"This table provides a patient/visit count, by sex, for ILI/H1N1 diagnosis."
...
ILIAVM ;EP - meds
 D HEADER^APCLSILR Q:$D(APCLQUIT)
 W "TABLE 4:  ILI / H1N1 Anti-Viral Medications Dispensed"
 W !,"This table provides a count by drug name of the number of visits"
 W !,"on which Anti-Viral Medication was dispensed.  An unduplicated"
 W !,"count of patients is also provided.",!,?40,"# patients",?60,"# visits",!
 ...
 Q
SUBHEAD3 ;
 W !,"TABLE 3:  ILI / H1N1 Diagnoses by Sex",!,?40,"# patients",?60,"# visits",!
 Q
SUBHEAD4 ;
 W "TABLE 4:  ILI / H1N1 Anti-Viral Medications Dispensed",!!,?40,"# patients",?60,"# prescriptions",!
 Q
ILIAGEP ;EP
 D HEADER^APCLSILR
 W "TABLE 5:  ILI / H1N1 Diagnoses by Age by Visit"
 W !,"This table displays a visit count by age group.  Only visits on which "
 W !,"there was at least one ILI or H1N1 diagnosis are counted.  The visits"
 W !,"have to be defined as 'surveillance' visits.  The definition of these "
 W !,"visits is the following:"
 W !,"   - a Hospitalization"
 W !,"   - a visit to a PHN"
 ...
 W !,"Ambulatory"
 W ?14,$$C($G(APCLAGEG("I","A","6-23m")),0,7)
 W ?22,$$C($G(APCLAGEG("I","A","24-59m")),0,7)
 W ?30,$$C($G(APCLAGEG("I","A","60m-18y")),0,7)
 W ?38,$$C($G(APCLAGEG("I","A","19-24y")),0,7)
 W ?46,$$C($G(APCLAGEG("I","A","25-49y")),0,7)
 W ?54,$$C($G(APCLAGEG("I","A","50-64y")),0,7)
 W ?62,$$C($G(APCLAGEG("I","A","65+y")),0,7)
 W ?72,$$C($G(APCLAGEG("I","A","TOTAL")),0,7),!
 W "ILI DXS",!
 W $$REPEAT^XLFSTR("-",79),!
 W !,"Ambulatory"
 ...
 W $$REPEAT^XLFSTR("-",79),!
 W !,"Hospital"
 W ?14,$$C($G(APCLAGEG("I","H","6-23m")),0,7)
 W ?22,$$C($G(APCLAGEG("I","H","24-59m")),0,7)
 W ?30,$$C($G(APCLAGEG("I","H","60m-18y")),0,7)
 W ?38,$$C($G(APCLAGEG("I","H","19-24y")),0,7)
 W ?46,$$C($G(APCLAGEG("I","H","25-49y")),0,7)
 W ?54,$$C($G(APCLAGEG("I","H","50-64y")),0,7)
 W ?62,$$C($G(APCLAGEG("I","H","65+y")),0,7)
 W ?72,$$C($G(APCLAGEG("I","H","TOTAL")),0,7),!
 W "ILI DXS",!
 W $$REPEAT^XLFSTR("-",79),!
 W !,"Hospital"
...
VACAGEP ;EP
 D HEADER^APCLSILR
 W "TABLE 6:  Seasonal Flu Immunizations by Age by Visit"
 ...
 W !," - Seasonal Flu:  Immunization CVX codes 15, 16, 88, 111, 135, 140, 141"
 W !,"                  CPT 90655-90662, 90724, G0008, G8108"
 W !,"                  Procedure 99.52, Diagnoses V04.8, V04.81, V06.6"
 I APCLLOCT="O" D HEADER^APCLSILR  Q:$D(APCLQUIT)  G LOCAGE
 W !!,"ALL FACILITIES"
 W !!,"Age",?14," 6-23m",?22,"24-59m",?30,"60m-18y",?38,"19-24y",?46,"25-49y",?54,"50-64y",?62,"  65+y",?72,"TOTAL",!
 W !,"Seasonal"
