...
HDR ;EP -- header code
 ...
 S X=" #",$E(X,6)="VISIT DATE",$E(X,21)="PATIENT NAME",$E(X,35)="HRN",$E(X,42)="FAC",$E(X,47)="HOSP LOC",$E(X,58)="CL",$E(X,61)="INS",$E(X,66)="PRIM PROV",$E(X,76)="STATUS ERROR"
 S VALMHDR(3)=X
...
GATHER ;
 ...
 ..I $P(^APCDSITE(DUZ(2),0),U,28)=0 Q:'$D(^AUPNVPRV("AD",APCDVIEN))  ;no provider
