ABSPOSCD ; IHS/FCS/DRS - ABSP("RX",*) ;      [ 10/28/2002  2:40 PM ]
 ;;1.0;PHARMACY POINT OF SALE;**3,10,12,18,19,20,21,23,32,36,40**;JUN 21, 2001
 ;---
...
MEDINFO(VMEDINFO,MEDN,INSPINS) ;EP
 ...
 I ABSP("NCPDP","Version")[5 D DURVALUE(IEN59,MEDN)
 ;
 ;IHS/SD/RLT - 06/27/07 - 10/18/07 - Patch 23
 ; Diagnosis Code
 I ABSP("NCPDP","Version")[5 D DIAGVAL(IEN59,MEDN)
 ;
