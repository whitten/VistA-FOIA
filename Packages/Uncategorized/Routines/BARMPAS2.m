...
STMTP  ; added sorts for loc & dos
 ...
 . ;S (BARBILLD,BARITOT,BARPTOT,BARATOT,BARPRSP,BARPTAC,BARINSOW)=0  ;bar*1.8*20 IHS/SD/PKD 2/17/11
 . S (BARBILLD,BARITOT,BARPTOT,BARATOT,BARPRSP,BARPTAC,BARINSOW,BARCXL)=0  ;bar*1.8*20 IHS/SD/PKD 2/17/11
 . D BLDA
 . S BARPBNUM=BARBNUM_" "
...
BLDA2 ;
 ...
 . Q:DUZ2=""  ; IHS/SD/PKD 1.8*20 Quit if TPB BAR(22) not a DUZ(2)
...
SUM ; EP
 ...
 D PG^BARMPAS3(18)  ;IHS/SD/PKD 2/22/11 1.8*20
 ...
 W ?66,"$",$J(BARAGE,9,2)
 W !,BARLINE,!
 D PG^BARMPAS3(10)   ; IHS/SD/PKD 2/22/11 1.8*20  PageBreaks
