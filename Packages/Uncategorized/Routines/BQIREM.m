...
EN(DATA,DFN) ; EP -- BQI PATIENT NATIONAL REMINDERS
 ...
 . S ORD(PRI,RIEN)=RCAT_U_RCLIN_U_REMCODE_U_REMDESC_U_$$FMTE^BQIUL1(REMLAST)_U_REMNEXT_U_$$FMTE^BQIUL1(REMDUE)_U_$$FMTE^BQIUL1(UPDT)_U_VISIT
 ;
 S PRI=""
...
HDR ; Header
 ...
 S @DATA@(BQII)=@DATA@(BQII)_"T00040REM_NEXT^D00010REM_DUE^D00030LAST_UPDATED^I00010VISIT_IEN^I00003DISPLAY_ORDER"_$C(30)
 Q
 ;
ERR ;
 D ^%ZTER
