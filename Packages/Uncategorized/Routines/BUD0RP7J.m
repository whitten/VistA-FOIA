BUD0RP7J ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
HTRL ;EP
 ...
 D HTRH Q:BUDQUIT
 I '$D(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR")) W !!,"No patients to report." Q
 D HTRL1
...
HTRL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D HTRL2
 Q
HTRL2 ;
 S BUDSTOT=0
 S BUDRACEL=$$RACEL^BUD0RP7I(BUDRACE,BUDETH)
 W !,BUDRACEL
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDALL=^XTMP("BUD0RP7",BUDJ,BUDH,"HTR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"#",1)
...
HTCRL ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D HTCRH Q:BUDQUIT
 I '$D(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR")) W !!,"No patients to report." Q
 D HTCRL1
...
HTCRL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D HTCRL2
 Q
HTCRL2 ;
 S BUDSTOT=0
 S BUDRACEL=$$RACEL^BUD0RP7I(BUDRACE,BUDETH)
 W !,BUDRACEL
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDHISV=$$HISP^BUD0RPTC(DFN)
 ....W ?24,$P(BUDHISV,U,3)," (",$P(BUDHISV,U,2),")",!
 ....S BUDALL=^XTMP("BUD0RP7",BUDJ,BUDH,"HTCR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"^",1)
 ....W ?5,$P(BUDALL,"^",2),!
 ....F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 .....I $Y>(IOSL-3) D HTCRH Q:BUDQUIT  W !,BUDRACEL,!
...
HTURL ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D HTURH Q:BUDQUIT
 I '$D(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR")) W !!,"No patients to report." Q
 D HTURL1
...
HTURL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D
 .S BUDETH="" F  S BUDETH=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH)) Q:BUDETH=""!(BUDQUIT)  D HTURL2
 Q
HTURL2 ;
 S BUDSTOT=0
 S BUDRACEL=$$RACEL^BUD0RP7I(BUDRACE,BUDETH)
 W !,BUDRACEL
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....S BUDHISV=$$HISP^BUD0RPTC(DFN)
 ....W ?24,$P(BUDHISV,U,3)," (",$P(BUDHISV,U,2),")",!
 ....S BUDALL=^XTMP("BUD0RP7",BUDJ,BUDH,"HTUR",BUDRACE,BUDETH,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"#",1)
 ....W ?5,$P(BUDALL,"#",2),!
 ....F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 .....I $Y>(IOSL-3) D HTURH Q:BUDQUIT  W !,BUDRACEL,!
