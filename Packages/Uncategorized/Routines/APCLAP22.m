...
DX ;EP
 ...
 I $P($$ICDDX^ICDCODE($P(^AUPNVPOV(APCLPPOV,0),U),APCLVDT),U,1)=-1 S APCLSRT2="?????",APCLDX=$P($$ICDDX^ICDCODE($P(^AUPNVPOV(APCLPPOV,0),U),APCLVDT),U,2) Q
 S APCLSRT2=$P($$ICDDX^ICDCODE($P(^AUPNVPOV(APCLPPOV,0),U),APCLVDT),U,2)
 ;S APCLDX=$P(^ICD9($P(^AUPNVPOV(APCLPPOV,0),U),0),U,3)
 S APCLDX=$P($$ICDDX^ICDCODE($P(^AUPNVPOV(APCLPPOV,0),U),APCLVDT),U,4)
 Q
