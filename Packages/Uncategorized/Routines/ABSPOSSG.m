ABSPOSSG ; IHS/SD/lwj - Special gets for formats ;      [ 12/23/2002  8:10 AM ]
 ;;1.0;PHARMACY POINT OF SALE;**1,2,3,4,5**;JUN 21, 2001
 ;----------------------------------------------------------------------
 ; IHS/SD/lwj 07/31/02
...
FLD439 ;Reason for service code
 ...
 ;
 ;5.1 Set
 I $G(ABSP51) S $P(^ABSPC(ABSP(9002313.02),400,ABSP(9002313.0201),473.01,DUR,0),U,2)=ABSP("X")
 ;
 Q
 ;
FLD440 ;Professional Service Code
 ...
 ;
 ;5.1 Set
 I $G(ABSP51) S $P(^ABSPC(ABSP(9002313.02),400,ABSP(9002313.0201),473.01,DUR,0),U,3)=ABSP("X")
 ;
 Q
 ;
FLD441 ;Result of Service Code
 ...
 ;
 ;5.1 Set
 I $G(ABSP51) S $P(^ABSPC(ABSP(9002313.02),400,ABSP(9002313.0201),473.01,DUR,0),U,4)=ABSP("X")
 ;
 Q
 ;
