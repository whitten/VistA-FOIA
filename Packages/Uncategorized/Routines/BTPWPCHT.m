...
ADD(APCDPAT,APCDVSIT,APCDALVR) ; EP 
 ...
 Q RESULT
 ;
DEF(CLN,CNAM,DFN,APCDLOC) ; Set variables
...
RPC(DATA,DFN,PARMS) ; EP -- BTPW CREATE CHART REVIEW
 ...
 S CLN=APCDALVR("APCDCLN"),CLN=$O(^DIC(40.7,"C",CLN,"")),APCDALVR("APCDCLN")=CLN
 ...
 S APCDALVR("APCDTPOV")="V68.9",APCDALVR("APCDTNQ")="iCare Chart Review"
...
TRIG(DATA,APCDCLN) ;EP -- BTPW CHART REVIEW TRIGGER
 NEW UID,II,VALUE,SOURCE,TYPE,ABLE
 S UID=$S($G(ZTSK):"Z"_ZTSK,1:$J)
 ...
 S SOURCE="APCDCAT",TYPE="C",ABLE="Y" D UP
 Q
 ;
UP ; Update
