BUD0RP7S ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
DME3L ;EP
 ...
 D DME3H Q:BUDQUIT
 I '$D(^XTMP("BUD0RP7",BUDJ,BUDH,"DME3")) W !!,"No patients to report." Q
 D DME3L1
...
DME3L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"DME3",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DME3L2
 Q
DME3L2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD0RP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ...S BUDALL=^XTMP("BUD0RP7",BUDJ,BUDH,"DME3",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
