BUD8RPP1 ; IHS/CMI/LAB - UDS PRINT TABLE 6 05 Dec 2007 6:26 AM 30 Dec 2008 10:42 AM ;
 ;;5.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2011;Build 12
T6 ;EP
 S BUDPG=0,BUDQUIT="",BUDFNP=1,BUDTYPE="D"
 D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH
 K BUDFNP
 ...
 I $Y>(IOSL-3) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH1
 W !,"22.  Mammogram",?33,"CPT-4: 76090-76092, G0202, G0204, G0206",!?33,"77051-77054, 77055-77057, 77058-77059",!,?33,"ICD-9: V76.11, V76.12",!?33,"793.80, 793.81, 793.89",!,?33,"VProc 87.36-.37"
 ...
 I $Y>(IOSL-3) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH1
 W !,"23.  Pap Test",?33,"CPT-4: 88141-88155, 88164-88167",!?33,"88160-88162, 88174, 88175,"
 W !?33,"G0101, G0123, G0124, G0141, G0143,",!?33,"G0144, G0145, G0147, G0148, P3000",!?33,"P3001, Q0091"
 W !?33,"ICD-9: V72.3, V72.31, V76.2, V72.32,",!?33,"V76.47, V67.01; 795.0*; ",!?33,"VLab Pap Smear; WH Pap Smear; "
 W !?33,"VProc 91.46; LOINC & site",!,?33,"defined taxonomies",?56,$$C($P(BUDT6("V"),U,23)),?70,$$C($P(BUDT6("P"),U,23)),!,BUD80L
 I $Y>(IOSL-13) D HEADER^BUD8RPTP Q:BUDQUIT  D T6SH1
