...
ANTICOAG(P,BDATE,EDATE,APCHAD) ;EP - was there ANTICOAG
 ...
 ;I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL WARF^2"
 ;S T=$O(^ATXAX("B","DM AUDIT ANTI-PLATELET DRUGS",0))
 ;S G=$$REFTAX^APCHSMU1(P,50,T,EDATE,EDATE)
 ;I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ANTI-PLT^2"
 ;S T=$O(^ATXAX("B","D AUDIT ASPIRIN DRUGS",0))
 ;S G=$$REFTAX^APCHSMU1(P,50,T,EDATE,EDATE)
 ;I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ASA^2"
 ...
 .S G=$$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ANTI-PLT^2"
 I G]"" Q G
 S G=$$REFUSAL^APCHSMU(P,81,+$$CODEN^ICPTCOD("4073F"),EDATE,EDATE)
 I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ANTI-PLT [4073F]^2"
 S G=$$REFUSAL^APCHSMU(P,81,+$$CODEN^ICPTCOD("4075F"),EDATE,EDATE)
 I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ANTI-PLT [4075F]^2"
 S G=$$REFUSAL^APCHSMU(P,81,+$$CODEN^ICPTCOD("G8006"),EDATE,EDATE)
 I G Q $$FMTE^XLFDT(EDATE)_" ZZZZZ: REFUSAL ANTI-PLT [G8006]^2"
