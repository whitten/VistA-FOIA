...
REFUSAL ;refusal component
 ...
 ..W ?5,"Refusal Type:  ",$$VAL^XBDIQ1(9000022,APCHSI,.07),!
 ...
 ..W ?5,"Refusal Type:  ",$$VAL^XBDIQ1(9002084.11,APCHSI,.03),!
 Q
LER ;refusal component
 ...
 ..W ?3,$E(APCHSI,1,30),?38,"(",$E($$UP^XLFSTR(APCHSRT),1,20),")",?65,$$FMTE^XLFDT(9999999-APCHSD,5),!
 ..;W ?5,"Refusal Type:  ",APCHSRT,!
 ;.S APCHSI="" F  S APCHSI=$O(APCHSX("IMM",APCHSI)) Q:APCHSI=""!($D(APCHSQIT))  D
 ;..X APCHSCKP Q:$D(APCHSQIT)
 ;..S APCHSD=$O(APCHSX("IMM",APCHSI,0)) W ?3,$$FMTE^XLFDT(9999999-APCHSD),?17,APCHSI,!
 ;..W ?5,"Refusal Type:  ",$$VAL^XBDIQ1(9002084.11,APCHSX("IMM",APCHSI,APCHSD),.03),!
 Q
