BUD8RPL2 ; IHS/CMI/LAB - UDS print lists ;
 ;;5.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2011;Build 12
 ;
T52 ;EP
 S BUDP=0,BUD8L=35
 I '$D(^XTMP("BUD8RPT1",BUDJ,BUDH,"T5",BUD8L)) D T52H W !!,"No Uncategorized Provider visits to report." Q
 D T52H
 S BUD8L=35,BUD8L2=0,BUDY=$O(^BUDGTFIV("B",BUD8L,0)),BUDY=$P(^BUDGTFIV(BUDY,0),U,2)
 W !!,"Line ",BUD8L,"   ",BUDY
...
T5W ;
 ...
 ..I $Y>(IOSL-3) D T52H Q:BUDQUIT  W !!,"Line ",BUD8L,"   ",BUDY
