...
T6 ;EP
 ...
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-6) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-4) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH
 ...
 I $Y>(IOSL-12) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH
 ...
 ;
SRV ;
 S BUDTYPE="S" D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 ...
 I $Y>(IOSL-6) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"22.  Mammogram",?33,"CPT-4: 76090-76092",!,?33,"ICD-9: V76.1x",!,?33,"VProc 87.35-.37",!?33,"WH Screening Mammogram",!?33,"WH Mammogram DX Bilat",!?33,"WH Mammogram DX Unilat"
 W ?56,$$C($P(BUDT6("V"),U,22)),?70,$$C($P(BUDT6("P"),U,22)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"23.  Pap Smear",?33,"CPT-4: 88141-88155, 88164-88167",!?33,"CPT-4: 88160-88162",!?33,"ICD-9: V72.3, V76.2; VLab Pap Smear;",!?33,"WH Pap Smear; "
 W ?33,"VProc 91.46; LOINC & site",!,?33,"defined taxonomies",?56,$$C($P(BUDT6("V"),U,23)),?70,$$C($P(BUDT6("P"),U,23)),!,BUD80L
 I $Y>(IOSL-13) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
...
DENT ;
 ...
 W !,"27.  I. Emergency Services",?34,"ADA: 9110, 0140",?56,$$C($P(BUDT6("V"),U,27)),?70,$$C($P(BUDT6("P"),U,27)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"28.  II. Oral Exams",?34,"ADA: 0120, 0150",?56,$$C($P(BUDT6("V"),U,28)),?70,$$C($P(BUDT6("P"),U,28)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"29.      Prophylaxis - adult",?34,"ADA: 1110, 1120,",!?11,"or child",?34,"ADA: 1201, 1205",?56,$$C($P(BUDT6("V"),U,29)),?70,$$C($P(BUDT6("P"),U,29)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"30.      Sealants",?34,"ADA: 1351"
 W ?56,$$C($P(BUDT6("V"),U,30)),?70,$$C($P(BUDT6("P"),U,30)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"31.      Fluoride treatment",?34,"ADA: 1203",?56,$$C($P(BUDT6("V"),U,31)),?70,$$C($P(BUDT6("P"),U,31)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"32.  III. Restorative Services",?34,"ADA: 21xx, 23xx, 27xx"
 W ?56,$$C($P(BUDT6("V"),U,32)),?70,$$C($P(BUDT6("P"),U,32)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"33.  IV. Oral Surgery",?34,"ADA: 7110-7281"
 W ?56,$$C($P(BUDT6("V"),U,33)),?70,$$C($P(BUDT6("P"),U,33)),!,BUD80L
 I $Y>(IOSL-3) D HEADER^BUD4RPTP Q:BUDQUIT  D T6SH1
 W !,"34.  V. Rehabilitative services",?34,"ADA: 3xxx, 4xxx, 5xxx",!?34,"6xxx, 8xxx"
