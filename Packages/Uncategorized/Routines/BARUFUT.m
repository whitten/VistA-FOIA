BARUFUT ; IHS/SD/TPF - UTILITIES FOR UFMS ; 09/19/2007
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,7,13,17**;OCT 26, 2005
 ;HEAVILY MODIFIED TO MEET SAC SIZE REQUIREMENTS MRS:BAR*1.8*7
 ;SUBROUTINES MOVED TO BARUFUT0 MRS:BAR*1.8*7
 ;
 ; IHS/SD/SDR 5/6/09 HEAT3915 BAR*1.8*13
 ;    Prevent duplicate files transmitted from A/R
 ;
 Q
 ;
...
OPENSTAT(UDUZ) ;EP - RETURN LAST SESSION DATE THAT IS OPEN
 N SESSID
 S SESSID=$O(^BARSESS(DUZ(2),"C","OPEN",UDUZ,""))
 Q SESSID
 ;
...
ASKACT1 ;EP -
 ...
 I ACTION="T" D
 .D EXPORTSUM^BARUFSUP(LIST(CHOICE),0)  ;EXPORT SUMMARY
 .D TRANSMIT(UDUZ,SESSID,ACTION)  ;MAKE SURE IT IS "T" ;MRS:BAR*1.8*7 IM30562
 .D EXPORTSUM^BARUFSUP(LIST(CHOICE),1)
 .;END BAR*1.8*17
 Q
 ;
