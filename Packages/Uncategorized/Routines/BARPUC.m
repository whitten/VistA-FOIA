BARPUC ; IHS/SD/LSL - UN-ALLOCATED CASH JAN 16,1997 ; 01/26/2009
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,6,7,9,10,17,20**;OCT 26, 2005
 ;
 ; IHS/SD/SDR - v1.8 p20 - HEAT27205 - Don't quit if batch is part of lockdown - still display
 ; ********************************************
 ;
...
GETTX ;
 ...
 . ;Q:'$$CKDATE^BARPST($P(^BARTR(DUZ(2),BARTX,0),U,14),0,"COLLECTION")  ;IGNORE OLD BATCHES;MRS;BAR*1.8*6 DD 4.2.4  ;IHS/SD/AML 2/15/2011 HEAT27205
 . S ^TMP($J,"BARVL",BARTX)=""
