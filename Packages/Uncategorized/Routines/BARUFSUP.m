BARUFSUP ; IHS/SD/TPF - SUPERVISORY FUNCTIONS FOR UFMS ; 04/09/2008
 ;;1.8;IHS ACCOUNTS RECEIVABLE;**3,4,17**;APR 9, 2005
 Q
 ;
...
ALLSTAT(LIST,STATUS) ;EP - CHANGE THE STATUS OF ALL THE SESSIONS IN ARRAY 'LIST' TO STATUS
 ...
 .D EXPORTSUM(.LIST,0)  ;EXPORT SUMMARY
 ...
 .I +POSTING=1,(STATUS="RC") D  Q  ;IS THE USER STILL LOGGED ON OR POSTING?
 ..W !!,"CANNOT RECONCILE SESSION ",SESSID
...
EXPORTSUM(LIST,PRINT)  ;EXPORT SUMMARY
