BUD9RPC2 ; IHS/CMI/LAB - UDS TABLE 6 11 Dec 2007 12:15 PM ;
...
L26(BUDV) ;EP
 ...
 .I Z=99391!(Z=99392)!(Z=99393)!(Z=99381)!(Z=99382)!(Z=99383) S G=Z
 .Q
 Q G
L26A(BUDV) ;EP
 ;age 6-72 months
 S G=""
 S A=$$AGE^BUD9UTL2(DFN,2,$$VD^APCLV(BUDV))
 I A<6 Q G
 I A>72 Q G
 S G="" S X=0 F  S X=$O(^AUPNVCPT("AD",BUDV,X)) Q:X'=+X!(G]"")  D
 .S Z=$$VAL^XBDIQ1(9000010.18,X,.01)
