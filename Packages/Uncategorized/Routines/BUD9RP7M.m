BUD9RP7M ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B 30 Dec 2009 8:19 PM ;
...
DMEL ;EP
 ...
 D DMEH Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"DME")) W !!,"No patients to report." Q
 D DMEL1
...
DMEL1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DMEL2
 Q
DMEL2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 .S BUDA="" F  S BUDA=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE,BUDCOM,BUDA)) Q:BUDA=""!(BUDQUIT)  D
 ..S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE,BUDCOM,BUDA,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE,BUDCOM,BUDA,BUDNAME,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...
 ....W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,BUDA,?55,$E($P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),1,24),!
 ....S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ....S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"DME",BUDRACE,BUDCOM,BUDA,BUDNAME,DFN)
 ....S BUDPPV=$P(BUDALL,"#",1)
...
DME1L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D DME1H Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"DME1")) W !!,"No patients to report." Q
 D DME1L1
...
DME1L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME1",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DME1L2
 Q
DME1L2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME1",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME1",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME1",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D DME1H Q:BUDQUIT  W !,BUDRACE,!
 ...W !?2,$E($P(^DPT(DFN,0),U,1),1,20),?24,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2))
 ...W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,$$AGE^AUPNPAT(DFN,BUDED),?55,$E($P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),1,24),!
 ...S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ...S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"DME1",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
 ...F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D DME1H Q:BUDQUIT  W !,BUDRACE,!
...
DME2L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D DME2H Q:BUDQUIT
 I '$D(^XTMP("BUD9RP7",BUDJ,BUDH,"DME2")) W !!,"No patients to report." Q
 D DME2L1
...
DME2L1 ;
 ...
 S BUDTOT=0
 S BUDRACE="" F  S BUDRACE=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME2",BUDRACE)) Q:BUDRACE=""!(BUDQUIT)  D DME2L2
 Q
DME2L2 ;
 S BUDSTOT=0
 W !,BUDRACE
 S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME2",BUDRACE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 .S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME2",BUDRACE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ..S DFN=0 F  S DFN=$O(^XTMP("BUD9RP7",BUDJ,BUDH,"DME2",BUDRACE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ...I $Y>(IOSL-3) D DME2H Q:BUDQUIT  W !,BUDRACE,!
 ...W !?2,$E($P(^DPT(DFN,0),U,1),1,20),?24,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2))
 ...W ?36,$E(BUDCOM,1,10),?47,$P(^DPT(DFN,0),U,2),?51,$$AGE^AUPNPAT(DFN,BUDED),?55,$E($P($$HISP^BUD9RPTC(DFN),U,2)_"-"_$P($$HISP^BUD9RPTC(DFN),U,3),1,24),!
 ...S BUDTOT=BUDTOT+1,BUDSTOT=BUDSTOT+1
 ...S BUDALL=^XTMP("BUD9RP7",BUDJ,BUDH,"DME2",BUDRACE,BUDNAME,BUDCOM,DFN)
 ...W ?5,$P(BUDALL,U,2),!
 ...S BUDPPV=$P(BUDALL,"^",1)
 ...F BUDX=1:1 S BUDV=$P(BUDPPV,U,BUDX) Q:BUDV=""!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D DME2H Q:BUDQUIT  W !,BUDRACE,!
