BKMQQCR ;PRXM/HC/BWF - BKMV Quality of Care Report; [ 1/12/2005  7:16 PM ] ; 19 Sep 2005  2:10 PM
 ;;2.1;HIV MANAGEMENT SYSTEM;;Feb 07, 2011
 Q
 ; Check taxonomies - added per bugzilla #1497
 ;D FLTRMSG^BKMIMRP1 ; will be replaced by RPC call to BQITAXX
 ;
RUN(DATA,BKMRPOP,EDATE,OWNR,PLIEN,BKMTAG,DFN) ; EP - Run Quality of Care Report
 ;
 ; Input:
 ...
 S EDATE=EDATE_".24" ; Report should include info through midnight on the end date.
 S DFN=$G(DFN,""),OWNR=$G(OWNR),PLIEN=$G(PLIEN),PLNM=""
 ;
 I OWNR'="",PLIEN'="" D
 . N IENS,DA
