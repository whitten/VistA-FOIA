BUD0RP6P ; IHS/CMI/LAB - UDS REPORT DRIVER TABLE 6B ;
...
PAP1L ;EP
 ...
 D PAP1H Q:BUDQUIT
 I '$D(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1")) W !!,"No patients to report." Q
 D PAP1L1
...
PAP1L1 ;
 ...
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1",BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1",BUDAGE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1",BUDAGE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1",BUDAGE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D PAP1H Q:BUDQUIT
 ...
 ....S BUDTOT=BUDTOT+1
 ....S BUDALL=^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP1",BUDAGE,BUDNAME,BUDCOM,DFN)
...
PAP2L ;EP
 S BUDP=0,BUDQUIT=0,BUDTOT=0
 D PAP2H Q:BUDQUIT
 I '$D(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2")) W !!,"No patients to report." Q
 D PAP2L1
...
PAP2L1 ;
 ...
 S BUDAGE="" F  S BUDAGE=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2",BUDAGE)) Q:BUDAGE=""!(BUDQUIT)  D
 .S BUDNAME="" F  S BUDNAME=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2",BUDAGE,BUDNAME)) Q:BUDNAME=""!(BUDQUIT)  D
 ..S BUDCOM="" F  S BUDCOM=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2",BUDAGE,BUDNAME,BUDCOM)) Q:BUDCOM=""!(BUDQUIT)  D
 ...S DFN=0 F  S DFN=$O(^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2",BUDAGE,BUDNAME,BUDCOM,DFN)) Q:DFN'=+DFN!(BUDQUIT)  D
 ....I $Y>(IOSL-3) D PAP2H Q:BUDQUIT
 ....W !,$E($P(^DPT(DFN,0),U,1),1,25),?29,$S($$HRN^AUPNPAT(DFN,BUDSITE)]"":$$HRN^AUPNPAT(DFN,BUDSITE,2),1:$$HRN^AUPNPAT(DFN,DUZ(2),2)),?41,$E(BUDCOM,1,25),?68,BUDAGE,!
 ....S BUDTOT=BUDTOT+1
 ....S BUDALL=^XTMP("BUD0RP6B",BUDJ,BUDH,"PAP2",BUDAGE,BUDNAME,BUDCOM,DFN)
 ....W ?5,$P(BUDALL,U,1),?19,$P(BUDALL,U,2),?35,$P(BUDALL,U,3),?45,$P(BUDALL,U,4),?53,$E($P(BUDALL,U,5),1,11),?65,$E($P(BUDALL,U,6),1,15)
 Q
PAP2H ;
 G:'BUDGPG PAP2H1
