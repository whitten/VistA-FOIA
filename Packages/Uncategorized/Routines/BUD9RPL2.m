BUD9RPL2 ; IHS/CMI/LAB - UDS print lists ;
 ;;5.0;IHS/RPMS UNIFORM DATA SYSTEM;;JAN 18, 2011;Build 12
 ;
T52 ;EP
 S BUDP=0,BUD9L=35
 I '$D(^XTMP("BUD9RPT1",BUDJ,BUDH,"T5",BUD9L)) D T52H W !!,"No Uncategorized Provider visits to report." Q
 D T52H
 S BUD9L=35,BUD9L2=0,BUDY=$O(^BUDNTFIV("B",BUD9L,0)),BUDY=$P(^BUDNTFIV(BUDY,0),U,2)
 W !!,"Line ",BUD9L,"   ",BUDY
...
T5W ;
 ...
 W ?51,$P(^DPT(DFN,0),U,2),?55,$$AGE^AUPNPAT(DFN,BUDCAD),?60,$E($P($$RACE^BUD9RPTC(DFN),U,4),1,15)," (",$P($$RACE^BUD9RPTC(DFN),U,3),")"
 ...
 ..I $Y>(IOSL-3) D T52H Q:BUDQUIT  W !!,"Line ",BUD9L,"   ",BUDY
