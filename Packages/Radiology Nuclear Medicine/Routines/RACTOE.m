RACTOE ; GENERATED FROM 'RA ORDER EXAM' INPUT TEMPLATE(#1453), FILE 75.1;11/17/04
 D DE G BEGIN
...
BEGIN S DNM="RACTOE",DQ=1
 ...
 M DIEZAR=^DIE(1453,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1453,U="^"
