RAUTL1 ;HISC/CAH,FPT,GJC AISC/MJK,RMO-Utility Routine ;10/22/97  13:54
 ;;5.0;Radiology/Nuclear Medicine;**5,9,18**;Mar 16, 1998
 ;last midification by SS for P18 June 19,00
...
UP1 N RA8 S RA8=0 ;use this to flag when one alert has been sent
 ...
 S RACNI=RACNISAV
 G UPK
UP2 S DA(2)=RADFN,DA(1)=RADTI,DA=RACNI,DIE="^RADPT("_DA(2)_",""DT"","_DA(1)_",""P"","
 N RAAFTER,RABEFORE
