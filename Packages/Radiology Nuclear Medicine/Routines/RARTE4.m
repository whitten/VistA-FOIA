RARTE4 ;HISC/GJC-Edit/Delete Reports (cont);11/4/97  08:02 ;2/8/02  15:43
...
IN1 ;skip to here if div param disallows rpt copying
 ...
 S DR(2,70.03)="15"  ;IHS/ITSC/CLS 02/08/2004 don't ask primary resident
 ...
 S DR(2,70.03)=DR(2,70.03)_"//^S X=$S($D(RASTFF)&($D(RABTCH)):RASTFF,1:"""");S:$D(^VA(200,+X,0)) RASTFF=$P(^(0),U);I X'>0 S Y=""@1"";@1;S RAFIN="""""  ;IHS/ITSC/CLS 02/08/2004
