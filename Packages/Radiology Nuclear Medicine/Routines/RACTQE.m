RACTQE ; GENERATED FROM 'RA QUICK EXAM ORDER' INPUT TEMPLATE(#1458), FILE 75.1;11/17/04
 D DE G BEGIN
...
BEGIN S DNM="RACTQE",DQ=1
 ...
 M DIEZAR=^DIE(1458,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1458,U="^"
