...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;22",DV="P44'a",DU="",DLB="REQUESTING LOCATION",DIFLD=22
 S DE(DW)="C1^RACTQE3"
 S DU="SC("
 S X=RALIFN
 S Y=X
...
C1F1 Q
X1 Q
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW="0;5",DV="SX",DU="",DLB="REQUEST STATUS",DIFLD=5
 S DE(DW)="C2^RACTQE3"
