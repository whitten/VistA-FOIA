RACTWR ; GENERATED FROM 'RA REPORT EDIT' INPUT TEMPLATE(#1439), FILE 74;11/17/04
 D DE G BEGIN
...
BEGIN S DNM="RACTWR",DQ=1
 ...
 M DIEZAR=^DIE(1439,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1439,U="^"
