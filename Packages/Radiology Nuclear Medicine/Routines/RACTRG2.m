...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 S X=DG(DQ),DIC=DIE
 N RA,RAIMGTY S RA(0)=$G(^RADPT(DA(2),"DT",DA(1),0)),RAIMGTY=$P($G(^RA(79.2,+$P(RA(0),U,2),0)),U) X:RAIMGTY]""&('$D(^RA(72,"AA",RAIMGTY,9,X)))&('$D(^RA(72,"AA",RAIMGTY,0,X))) ^DD(70.03,3,9.2)
 S X=DG(DQ),DIC=DIE
 N RA,RAIMGTY S RA(0)=$G(^RADPT(DA(2),"DT",DA(1),0)),RAIMGTY=+$P(RA(0),U,2),RAIMGTY=$P($G(^RA(79.2,RAIMGTY,0)),U) S:RAIMGTY]""&('$D(^RA(72,"AA",RAIMGTY,9,X)))&('$D(^RA(72,"AA",RAIMGTY,0,X))) ^RADPT("AS",$E(X,1,30),DA(2),DA(1),DA)=""
C5F1 Q
X5 Q
...
C8S S X="" G:DG(DQ)=X C8F1 K DB
 ...
 ;
C8F1 Q
X8 S DIC("S")="I $P(^(0),U,6)'=""P"",$S('$D(^(""I"")):1,'^(""I""):1,DT'>^(""I""):1,1:0),$P(^RADPT(DA(2),""DT"",DA(1),0),U,2)=$P(^RAMIS(71,+Y,0),U,12)" X ^DD(70.03,2,9.2)
 Q
 ;
...
C15S S X="" G:DG(DQ)=X C15F1 K DB
 ...
 ;
C15F1 Q
X15 S DIC("S")="I $P(^(0),U,6)'=""P"",$S('$D(^(""I"")):1,'^(""I""):1,DT'>^(""I""):1,1:0),$P(^RADPT(DA(2),""DT"",DA(1),0),U,2)=$P(^RAMIS(71,+Y,0),U,12)" X ^DD(70.03,2,9.2)
 Q
 ;
